...
only move autonomously in a given environment but 
also communicate in real time for cooperation with other NAO team members (in a given game). The 
software is stable and
robust and now integrated with the dialog manager.
