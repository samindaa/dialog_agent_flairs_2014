...
speech-enabled systems against noisy speech recognition \cite{NjFunSingh02,young2013pomdp}. 
...
drinkers; \item and advice for drinkers with alcohol use {\em disorder} (e.g., coordinate care with 
specialist). \end{inparaenum} 
\end{inparaenum}
...
disorder}, it refers the user to treatment, e.g., refer to an addiction specialist, suggests a 
drinking goal.  If 
