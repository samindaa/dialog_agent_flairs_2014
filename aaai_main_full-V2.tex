...
%{\bf Subjective Evaluation}. After the subjects completed the intervention with the 3D-character, the subjects answered a survey aimed at evaluating the user's experience with the system. 
...
%However, as discussed above, because the current speech recognition engine on the NAO robot is slower than the speech recognition engine on the 3D-character, the subjective evaluation of the 3D-character dialog system is not indicative of the performance of the NAO system.
